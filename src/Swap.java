...
public class Swap {
  ...
  */
  ...
  public String toString() {
    return "Swap [trainer1=" + trainer1 + ", trainer2=" 
        + trainer2 + ", pokemon1=" + pokemon1 + ", pokemon2="
  ...
  */
  ...
  public void execute(Trainer trainer1,Trainer trainer2 , Pokemon pokemon1, Pokemon pokemon2) {
    if (trainer1 == trainer2) {
      ...
      System.out.println("Pokemon " + pokemon1.getName() + " oder "
          + pokemon2.getName() + " ist untauschbar");
